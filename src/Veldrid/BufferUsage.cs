...
namespace Veldrid
{
    ...
    public enum BufferUsage : byte
    {
        ...
        ///     This flag enables the use of a Buffer in the <see cref="CommandList.SetIndexBuffer(DeviceBuffer, IndexFormat)" />
        ///     method.
        /// </summary>
        IndexBuffer = 1 << 1,
        ...
        ///     mapped with <see cref="MapMode.Write" />. This flag cannot be combined with
        ///     <see cref="StructuredBufferReadWrite" />
