...
namespace Veldrid
{
    ...
    public struct GraphicsDeviceOptions
    {
        ...
        /// <summary>
        ///     Indicates whether a 0-to-1 depth range mapping is preferred. For OpenGL, this is not the default, and is not
        ///     available
        ///     on all systems.
        /// </summary>
        ...
        ///     Indicates whether a 0-to-1 depth range mapping is preferred. For OpenGL,
        ///     this is not the default, and is not available on all systems.
        /// </param>
        public GraphicsDeviceOptions(
            bool debug,
            PixelFormat? swapchainDepthFormat,
