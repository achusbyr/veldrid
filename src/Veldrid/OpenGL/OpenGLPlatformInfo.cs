...
{
    /// <summary>
    ///     Encapsulates various pieces of OpenGL context, necessary for creating a <see cref="GraphicsDevice" /> using the
    ///     OpenGL
    ///     API.
    /// </summary>
    public class OpenGLPlatformInfo
    {
        ...
        /// <param name="makeCurrent">
        ///     A delegate which can be used to make the given OpenGL context current on the calling
        ///     thread.
        /// </param>
        ...
        ///     A delegate which can be used to swap the main back buffer associated with the OpenGL
        ///     context.
        /// </param>
        /// <param name="setSyncToVerticalBlank">
        ///     A delegate which can be used to set the synchronization behavior of the OpenGL
        ///     context.
        /// </param>
        ...
        ///     context.
        /// </param>
        /// <param name="setSwapchainFramebuffer">
        ///     A delegate which can be used to set the framebuffer used to render to the
        ///     application Swapchain.
        /// </param>
        /// <param name="resizeSwapchain">
        ///     A delegate which is invoked when the main Swapchain is resized. This may be null,
        ///     in which case no special action is taken when the Swapchain is resized.
        /// </param>
        public OpenGLPlatformInfo(
            IntPtr openGLContextHandle,
            Func<string, IntPtr> getProcAddress,
